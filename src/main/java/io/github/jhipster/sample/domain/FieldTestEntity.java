...
public class FieldTestEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_tom", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredTom;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_tom", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinTom;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_tom", precision = 21, scale = 2)
    ...
    @Column(name = "duration_tom")
    private Duration durationTom;

    @NotNull
    @Column(name = "duration_required_tom", nullable = false)
