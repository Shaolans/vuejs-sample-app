...
import FieldTestEntityUpdateComponent from '@/entities/field-test-entity/field-test-entity-update.vue';
import FieldTestEntityClass from '@/entities/field-test-entity/field-test-entity-update.component';
...
describe('Component Tests', () => {
  describe('FieldTestEntity Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<FieldTestEntityClass>(FieldTestEntityUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        // THEN
        expect(mockedAxios.put).toHaveBeenCalledWith('api/field-test-entities', entity);
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        // THEN
        expect(mockedAxios.post).toHaveBeenCalledWith('api/field-test-entities', entity);
        expect(comp.isSaving).toEqual(false);
      });
    });
  });
