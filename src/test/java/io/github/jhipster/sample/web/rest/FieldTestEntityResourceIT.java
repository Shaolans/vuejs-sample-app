...
public class FieldTestEntityResourceIT {
    ...
    @Test
    @Transactional
    public void checkDurationRequiredTomIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestEntityRepository.findAll().size();
        // set the field null
    ...
    public void getAllFieldTestEntities() throws Exception {
        ...
        restFieldTestEntityMockMvc.perform(get("/api/field-test-entities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].durationTom").value(hasItem(DEFAULT_DURATION_TOM.toString())))
            .andExpect(jsonPath("$.[*].durationRequiredTom").value(hasItem(DEFAULT_DURATION_REQUIRED_TOM.toString())))
    ...
    public void getFieldTestEntity() throws Exception {
        ...
        restFieldTestEntityMockMvc.perform(get("/api/field-test-entities/{id}", fieldTestEntity.getId()))
            ...
            .andExpect(jsonPath("$.durationTom").value(DEFAULT_DURATION_TOM.toString()))
            .andExpect(jsonPath("$.durationRequiredTom").value(DEFAULT_DURATION_REQUIRED_TOM.toString()))
